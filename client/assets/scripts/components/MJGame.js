cc.Class({
    ...
    initView:function(){
        ...
        this._gamecount.string = "" + cc.vv.gameNetMgr.numOfGames + "/" + "4局";
        ...
        var mjcountChild = gameChild.getChildByName("mjcount");
        mjcountChild.active = true;
        var gamecountChild = gameChild.getChildByName("gamecount");
        gamecountChild.active = true;
    ...
    initEventHandlers:function(){
        ...
        this.node.on('game_num',function(data){
           self._gamecount.string = "" + cc.vv.gameNetMgr.numOfGames + "/" + "4局";
        });
    ...
    update: function (dt) {
        this.node.getChildByName("game").getChildByName("arrow").active = true;
        cc.vv.audioMgr.playBGM("bgFight.mp3");
